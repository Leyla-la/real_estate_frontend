...
import { MapPin, User, Download, CreditCard, Edit, Mail, ArrowDownToLineIcon, Check, FileText } from "lucide-react";
...
const Residence = () => {
  ...
  if (!property || propertyError || leasesError || paymentsError)
